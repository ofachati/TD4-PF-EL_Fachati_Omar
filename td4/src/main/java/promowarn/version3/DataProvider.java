...
public class DataProvider {
    ...
    public DataProvider() {
        ...
        promotion(1).chooseDelegate(Optional.ofNullable(student(1)));
        //
        createPromotion(2).register(student(3)).register(student(4));
        promotion(2).chooseDelegate(Optional.ofNullable(student(1))); // voluntary bug
        //
        createPromotion(3).register(student(5)).register(student(6));
        promotion(3).chooseDelegate(Optional.ofNullable(student(5)));
        //
        createPromotion(4).register(student(7)); // no grades
        promotion(4).chooseDelegate(Optional.ofNullable(student(7)));
        //
